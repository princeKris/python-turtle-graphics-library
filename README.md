...
- 🧠 Optical illusions & mind-blowing animations
- 🎥 Perfect for YouTube Shorts, Reels & demos
- 🎓 Beginner-friendly & student-focused
- ⭐ Clean, reusable, well-organized code
...
```text
basics/        → Basic shapes & intro programs  
patterns/      → Repeating & geometric patterns  
illusions/     → Optical illusions & visual tricks  
animations/    → Moving & looping animations  
math_art/      → Fibonacci, fractals, mandalas  
